...
public class MapGenerator : MonoBehaviour {
    ...
    [Range(0,1)]
    public float obstaclePercent = .5f;
    ...
    public void GeneratorMap()
    {
        ...
        for (int i = 0; i < obstacleCount; i++)
        {
            ...
            if (randomCoord != mapCentre && MapIsFullyAccessible(obstacleMap, currentObstacleCount))
            {
                ...
                Transform newObstable = Instantiate(obstablePrefab, obstaclePosition + Vector3.up * .5f, Quaternion.identity) as Transform;
                newObstable.localScale = Vector3.one * (1 - outlinePercent) * tileSize;
